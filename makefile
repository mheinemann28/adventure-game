...
gameEngine: GameEngine.c GameEngine.h GameEngine_helpers.h RoomLoader.c RoomLoader.h CommandParser.c CommandParser.h
	gcc -g -o gameEngine GameEngine.c GameEngine.h GameEngine_helpers.h RoomLoader.c RoomLoader.h CommandParser.c CommandParser.h
