...
const char *verb_drop_synonyms[] = {"drop","leave","place","put"};
...
const int verb_hit_synonyms_size = 12;
const char *verb_hit_synonyms[] = {"hit","smack","fight","attack","charge","punch","kick","hurt","swing","give", "use", "unlock"};
